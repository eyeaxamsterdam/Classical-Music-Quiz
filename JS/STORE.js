const STORE = [
    ...
    },
    {
      ...
      correctAnswer: 2,
      correctResponse: `<p><img class=imgBank src="images/johnCage.jpg"></p><p>Correct! John Cage called for balls, books, metal, and all manner of every-day items be put into the piano to turn it into a completely different sounding instrument.</p>`,
    ...
    },
    {
      ...
      correctAnswer: 3,
      correctResponse: '<p><img class="imgBank" src="images/gpds.jpg"</p><p>Yes, that\'s correct! Stalin thought it "might be best for Dimitir Sh. to compose differently next time." Fun fact, it\'s a joke amung musicians that Shostakovich looks similar to Harry Potter.</p>',
      incorrectResponse: 'No, it is Shostakovich who was called out by Stalin. He thought it "might be best for Dimitir Sh. to compose differently next time."' 
    }
  ];